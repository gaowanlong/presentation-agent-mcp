...
export function layoutCaseStudySlide(slide: CaseStudySlide, style: StyleProfile): LayoutElement[] {
  ...
  elements.push(shapeElement({ x: leftX, y: startY + 0.4, w: colW, h: 1.5, shape: "roundRect", fill: style.colors.card_background, stroke: style.colors.border }));
  ...
  elements.push(shapeElement({ x: leftX, y: challengeY + 0.4, w: colW, h: 1.2, shape: "roundRect", fill: style.colors.card_background, stroke: style.colors.border }));
  ...
  elements.push(shapeElement({ x: rightX, y: startY + 0.4, w: colW, h: 1.5, shape: "roundRect", fill: style.colors.card_background, stroke: style.colors.border }));
  ...
  if (slide.metrics && slide.metrics.length > 0) {
    ...
    elements.push(shapeElement({ x: CANVAS_MARGIN_X, y: metricsY, w: contentWidth(style), h: 0.8, shape: "roundRect", fill: style.colors.primary + "12" }));
